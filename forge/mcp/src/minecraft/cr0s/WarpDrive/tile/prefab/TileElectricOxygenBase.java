...
public abstract class TileElectricOxygenBase extends TileEntityOxygenHandler implements IEnergyInterface, IEnergyContainer {
	protected EnergyStorageHandler energy;
    protected EntityPlayer player;
	    
    public TileElectricOxygenBase(long capacity, long maxReceive, long maxExtract) {
