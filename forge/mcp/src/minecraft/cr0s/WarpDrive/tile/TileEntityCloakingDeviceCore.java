...
public class TileEntityCloakingDeviceCore extends TileElectricBase implements//TODO GUI, add consume energy
	...
	private final static int MAX_ENERGY_VALUE = 500000000 * 250; // 500kk eU
			...
			for (int x = minX; x <= maxX; x++)
				for(int z = minZ; z <= maxZ; z++)
					if (worldObj.getBlockId(x, y, z) != 0)
						blocksCount++;
		int euToConsume = blocksCount * ((this.tier == 1) ? WarpDriveConfig.i.CD_ENERGY_PER_BLOCK_TIER1 : WarpDriveConfig.i.CD_ENERGY_PER_BLOCK_TIER2);
