...
public class WorldChunkManger0011 extends WorldChunkManager {
private GenLayer myGenBiomes;
private GenLayer myBiomeIndexLayer;
private BiomeCache myBiomeCache;
private List<BiomeGenBase> myBiomesToSpawnIn;

protected WorldChunkManger0011() {
	this.myBiomeCache = new BiomeCache(this);
	this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
	this.myBiomesToSpawnIn.add(BiomeList.T0011Main);
	this.myBiomesToSpawnIn.add(BiomeList.T0011Clearing);
}

public WorldChunkManger0011(long seed, WorldType worldtype) {
	this();
	GenLayer[] agenlayer = GenLayer0011.makeTheWorld(seed);
	this.myGenBiomes = agenlayer[0];
	this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkManger0011(World world) {
...
par1ArrayOfBiomeGenBase[i] = BiomeList.T0011Main;
}
}
