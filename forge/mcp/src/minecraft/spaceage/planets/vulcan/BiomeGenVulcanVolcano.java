...
public class BiomeGenVulcanVolcano extends BiomeGenBase {
  ...
  public BiomeGenVulcanVolcano(int par1) {
	  super(par1);
	    ...
	    this.customBiomeDecorator.vulcanVolcanoesPerChunk = 1;
  ...
  public WorldGenerator getRandomWorldGenForTrees(Random par1Random) {
    return new WorldGenVulcanVolcano();
  }
