...
public class WorldGenSoulSand extends WorldGenerator {
	  ...
	  public WorldGenSoulSand(int par1, int par2, int par3) {
	...
	public boolean generate(World world, Random random, int i, int j, int k) {
	    float var6 = random.nextFloat() * 3.141593F;
	    double var7 = i + 8 + MathHelper.sin(var6) * this.numberOfBlocks / 8.0F;
	    double var9 = i + 8 - MathHelper.sin(var6) * this.numberOfBlocks / 8.0F;
	    double var11 = k + 8 + MathHelper.cos(var6) * this.numberOfBlocks / 8.0F;
	    double var13 = k + 8 - MathHelper.cos(var6) * this.numberOfBlocks / 8.0F;
	    double var15 = j + random.nextInt(3) - 2;
	    double var17 = j + random.nextInt(3) - 2;
	          ...
	          for (int var41 = var33; var41 <= var36; var41++)
	          {
	            ...
	            if (var39 * var39 + var42 * var42 < 1.0D)
	            {
	              for (int var44 = var34; var44 <= var37; var44++)
	              {
	                ...
	                if ((var39 * var39 + var42 * var42 + var45 * var45 < 1.0D) && (world.getBlockId(var38, var41, var44) == blockIDToReplace))
	                {
