...
public class WorldChunkMangerHades extends WorldChunkManager {
...
public WorldChunkMangerHades(long seed, WorldType worldtype) {
	this();
	GenLayer[] agenlayer = GenLayerHades.makeTheWorld(seed);
	this.myGenBiomes = agenlayer[0];
	this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkMangerHades(World world) {
