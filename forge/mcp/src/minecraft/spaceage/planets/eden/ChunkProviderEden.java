...
public class ChunkProviderEden implements IChunkProvider {
	...
	public ChunkProviderEden(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        for (int c = 60; c > 0; c--) {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Block.dirt.blockID) && (worldObj.getBlockMetadata(j2, l3 - 1, j5) == 0)) {
                        new WorldGenEdenTrees(true).generate(worldObj, rand, j2, l3, j5);
                }
        }
