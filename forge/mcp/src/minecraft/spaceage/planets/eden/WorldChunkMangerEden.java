...
public class WorldChunkMangerEden extends WorldChunkManager {
	private GenLayer myGenBiomes;
	private GenLayer myBiomeIndexLayer;
	private BiomeCache myBiomeCache;
	private List<BiomeGenBase> myBiomesToSpawnIn;

	protected WorldChunkMangerEden() {
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(BiomeList.edenMain);
	}

	public WorldChunkMangerEden(long seed, WorldType worldtype) {
		this();
		GenLayer[] agenlayer = GenLayerEden.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkMangerEden(World world) {
...
//Change this to a biome
				par1ArrayOfBiomeGenBase[i] = BiomeList.edenMain;
			}
		}
