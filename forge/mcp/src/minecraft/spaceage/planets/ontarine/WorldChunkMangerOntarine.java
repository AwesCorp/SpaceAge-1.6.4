...
public class WorldChunkMangerOntarine extends WorldChunkManager {
	...
	public WorldChunkMangerOntarine(long seed, WorldType worldtype) {
		this();
		GenLayer[] agenlayer = GenLayerOntarine.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkMangerOntarine(World world) {
...
//Change this to a biome
				par1ArrayOfBiomeGenBase[i] = BiomeList.ontarineMain;
			}
		}
