...
public class ContainerLiquidTank extends Container {
	
	private TileLiquidTank tileEntity;
	
	public ContainerLiquidTank(InventoryPlayer player, TileLiquidTank tileEntity) {
